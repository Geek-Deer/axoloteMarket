        ...
        <div class="contenedor contenedor-enlaces-nav">
            ...
            <nav>
                ...
                <tr>
                    ...
                    <td>
                    <?php if(isset($_SESSION['email'])){ ?> <a href="carrito.php"><p style="position:absolute;"><?php 
                        if(isset($_SESSION['carrito'])) {
                            echo '('.count($_SESSION['carrito']).')'?></p><img src="https://cdn-icons-png.flaticon.com/512/2315/2315869.png" width="20px" height="20px"></a>
                    <?php }else{
                        echo '<a href="carrito.php"><img src="https://cdn-icons-png.flaticon.com/512/2315/2315869.png" width="20px" height="20px"><p stlye="color:white;">(0)</p></a>';
                    }
